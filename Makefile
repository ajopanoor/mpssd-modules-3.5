...
clean:
	rm -f Module.symvers mic.o mic.ko mic.mod.c mic.mod.o host/*.o host/vhost/*.o micscif/*.o mpssboot/*.o pm_scif/*.o ramoops/*.o ras/*.o trace_capture/*.o vcons/*.o virtio/*.o vnet/*.o dma/*.o
